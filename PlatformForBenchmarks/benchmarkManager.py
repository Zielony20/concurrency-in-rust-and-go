...
def sorting_tests2():
    parameters = [16 for x in range(101, 100001, 1000)]
    parameters2 = [x for x in range(101, 100001, 1000)]
    ...
    results = run_programs_with_parameters(programs, parameters, parameters2)
    plot_results(results, parameters2, names, 'Rozmiar tablicy na wątek', 'Czas trwania (s)',"sorting_tests_32wątków (buffor delete)")
    results.clear()
